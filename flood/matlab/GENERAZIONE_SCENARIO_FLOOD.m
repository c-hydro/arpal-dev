...
cd('/home/fabio/Documents/Work_Area/Code_Development/Workspace/PyCharm_Workspace/arpal-master/flood/')
path_codice=pwd;

path_data_geo='/home/fabio/Desktop/PyCharm_Workspace/arpal-ws/flood/data_static/geo_data/'
path_data_source='/home/fabio/Documents/Work_Area/Code_Development/Workspace/PyCharm_Workspace/arpal-ws/flood/data_static/';
path_data_dest='/home/fabio/Documents/Work_Area/Code_Development/Workspace/PyCharm_Workspace/arpal-ws/flood/data_dynamic/output/';

% percorso dove si trovano le simulazioni
path_dati_input=[path_data_source,'/telemac_data/'];
% percorso dove si trovano gli scenari
path_mappe_input=[path_data_source,'/hazard_data/'];
path_mappe_output=[path_data_dest,'/hazmap/'];
...
load([path_data_geo,'Data_LiguriaDomain.mat'])
...
if mode==1
    ...
    portate=[1435,2074,0,1000,1250,1300];
    % messo per ora
...
for uuu=1:quante_sez
    ...
    value1 = Qindice_dominio(sezioni_indici_relativi(uuu,1), sezioni_indici_relativi(uuu,2)).*0.5239
    
    value2 = (Qindice_dominio(sezioni_indici_relativi(uuu,1), sezioni_indici_relativi(uuu,2)).*0.5239) + portate(uuu)
    
    value3 = Qindice_dominio(sezioni_indici_relativi(uuu,1),sezioni_indici_relativi(uuu,2)).*1.0433
    
    value4 = exp(((Qindice_dominio(sezioni_indici_relativi(uuu,1),sezioni_indici_relativi(uuu,2)).*0.5239)+...
