...
% Dato il dominio <nome_dominio> (nella cui directory corrispondente devono essere
% presenti tutte le mappe di hazard interpolate e di cui deve essere
% disponibile la mappa delle aree di competenza 'aree_competenza_idro_',<nome_dominio>.mat), 
% e dati i tempi di ritorno <TT> verificatisi in un dato istante in tutte le sezioni, produce la
